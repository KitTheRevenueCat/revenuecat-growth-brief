...
CHUNK1_TEXT = (
    ...
    "built on top of the Charts A.P.I. Instead of rebuilding RevenueCat's dashboard, "
...
CHUNK2_TEXT = (
    "[steady] K.P.I. cards give you headline context: M.R.R., revenue, new customers, "
    "active subscriptions, active trials. "
    "Below the brief, supporting charts back every finding — "
    "revenue, M.R.R., conversion rate, and churn. "
    ...
    "No fake A.I. causality. No forecasting theater. "
